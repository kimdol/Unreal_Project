...
void ABaseCharacter::InitializeStatus()
{
    ...
    if (_defaultStatusEffect == nullptr)
    {
    ...
    if (_isBoundInput == false && GetAbilitySystemComponent() && IsValid(InputComponent))
    {
        ...
        GetAbilitySystemComponent()->BindAbilityActivationToInputComponent(
            ...
            FGameplayAbilityInputBinds(
                ...
                enumPath, static_cast<int32>(CCGProjAbilityID::ConfirmTarget),
                static_cast<int32>(CCGProjAbilityID::CancelTarget)
            )
        );
